  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[min(88vh,52rem)] w-[min(calc(100vw-1.5rem),46rem)] -translate-x-1/2 -translate-y-1/2 flex-col rounded-xl border border-outline/60 bg-surface p-4 shadow-[0_18px_46px_-30px_rgba(15,23,42,0.22)] outline-none dark:border-dark-outline/70 dark:bg-dark-surface-elevated sm:p-5">
